...
struct MaterialData {
	...
	static MaterialData GetMaterial(const std::string& name)
	{
		static const std::map<std::string, MaterialData> materials = {
			...
			{"glass", {{0.1f, 0.1f, 0.1f}, {0.1f, 0.1f, 0.1f}, {0.8, 0.8, 0.8}, 96.0f, 0.4f} },
			{"velvet", {{0.131f, 0.0f, 0.012f}, {0.131f, 0.0f, 0.012f}, {0.131f, 0.0f, 0.012f}, .078125f * 128.0f, 1.0f} },
			{"white fabric", {{1, 1, 1}, {1, 1, 1}, {1, 1, 1}, .078125f * 128.0f, 1.0f} },
			{"blue fabric", {{0.013f, 0, 0.167}, {0.013f, 0, 0.167}, {0.013f, 0, 0.167}, .078125f * 128.0f, 1.0f} },
			{"metal", {{0.1f, 0.1f, 0.1f}, {0.1f, 0.1f, 0.1f}, {0.8, 0.8, 0.8}, 77.0f, 1.0f} },
			{"metal green", {{0.005f, 0.068f, 0.0f}, {0.005f, 0.068f, 0.0f}, {0.005f, 0.068f, 0.0f}, 77.0f, 1.0f} },
			{"metal orange", {{0.802f, 0.222f, 0.0f}, {0.802f, 0.222f, 0.0f}, {0.802f, 0.222f, 0.0f}, 77.0f, 1.0f} },
			{"metal brown", {{0.022f, 0.006f, 0.0f}, {0.022f, 0.006f, 0.0f}, {0.022f, 0.006f, 0.0f}, 77.0f, 1.0f} },
